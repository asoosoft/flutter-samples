...
*/
AFlowThreeLineAttrProp = class AFlowThreeLineAttrProp extends BaseProp
{
    constructor()
    {
        super()
		...
		this.attrPath = 'Framework/afc/attribute/AFlowThreeLine/';
...
AFlowThreeLineAttrProp.prototype.init = function(context, evtListener)
{
...
AFlowThreeLineAttrProp.prototype.online_typeChange = function(comp, info, e)
{
...
AFlowThreeLineAttrProp.prototype.onColorPickerClick = function(comp, info)
{
...
AFlowThreeLineAttrProp.prototype.onNumberValueChange = function(comp, info, e)
{
	if(info > 100)
	{
		info = 100;
...
AFlowThreeLineAttrProp.prototype.onCheckBtnClick = function(comp, info, e)
{
	BaseProp.prototype.onCheckBtnClick.call(this, comp, info, e);
	
	if(comp.compId == "data-leaning-postion")
	{
		for(var i=0; i<this.selCompArr.length; i++)
		{
			this.selCompArr[i].drawPath();
...
AFlowThreeLineAttrProp.prototype.onStrokeWidthChange = function(comp, info, e)
{	
	if(info < 0) 
	{
		info = 0;
