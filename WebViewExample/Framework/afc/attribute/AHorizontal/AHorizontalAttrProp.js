...
class AHorizontalAttrProp extends BaseProp
{
	constructor()
	{
		super();
    ...
    init(context, evtListener)
    {
        ...
        //	AHorizontal 만의 추가적인 설정 화면을 제작합니다.
        //	프로젝트뷰에서 /afc/attribute/AHorizontal 폴더에 
...
window.AHorizontalAttrProp = AHorizontalAttrProp;
