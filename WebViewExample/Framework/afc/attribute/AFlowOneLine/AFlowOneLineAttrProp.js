...
*/
AFlowOneLineAttrProp = class AFlowOneLineAttrProp extends BaseProp
{
    constructor()
    {
        super()
		...
		this.attrPath = 'Framework/afc/attribute/AFlowOneLine/';
...
AFlowOneLineAttrProp.prototype.init = function(context, evtListener)
{
...
AFlowOneLineAttrProp.prototype.online_typeChange = function(comp, info, e)
{
	if(comp.compId == 'data-direct')
	{
		for(var i=0; i<this.selCompArr.length; i++)
		{
			this.selCompArr[i].setDirect(info);
		}
	}
...
AFlowOneLineAttrProp.prototype.onColorPickerClick = function(comp, info)
{
...
AFlowOneLineAttrProp.prototype.onCheckBtnClick = function(comp, info, e)
{
...
AFlowOneLineAttrProp.prototype.onStrokeWidthChange = function(comp, info, e)
{
	if(info < 0) 
	{
		info = 0;
