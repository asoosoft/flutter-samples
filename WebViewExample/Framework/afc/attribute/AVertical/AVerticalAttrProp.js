...
class AVerticalAttrProp extends BaseProp
{
	constructor()
	{
		super();
    ...
    init(context, evtListener)
    {
        ...
        //	AVertical 만의 추가적인 설정 화면을 제작합니다.
        //	프로젝트뷰에서 /afc/attribute/AVertical 폴더에 
        //	MyInfo.lay 파일을 추가합니다.(파일명은 설정화면을 잘 표현하는 이름으로 셋팅합니다.)
        
        //	layout 파일이 존재하는 경로
        //var attrPath = 'Framework/afc/attribute/AVertical/';
...
window.AVerticalAttrProp = AVerticalAttrProp;
