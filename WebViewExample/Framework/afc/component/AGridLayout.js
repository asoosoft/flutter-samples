...
class AGridLayout extends ALayout
{
	...
	_makeResizeBar()
	{
        ...
        this.resizeMgrH.setScaleGetter(()=> 
        {
            const layView = theApp_.getLayoutView()
            return layView ? layView.layWorkView.adjCanvas.curScaleVal : 1
        })

        this.resizeMgrV.setScaleGetter(()=> 
        {
            const layView = theApp_.getLayoutView()
            return layView ? layView.layWorkView.adjCanvas.curScaleVal : 1
        })
...
/*
    this.columnResizable((changedWidth, inx)=>
    {
        console.log(inx)
...
AGridLayout.prototype.checkFull = function()
{
	let ret = true
	this._findChildTd().each(function()
	{
...
//deprecated
AGridLayout.prototype.getColGroupItems = function() { return this.$colGroup.children().length; }
...
AGridLayout.prototype.setColSize = function(col, size)
{
	...
	this.getColGroupItem(col).attr('width', size);
...
AGridLayout.prototype.getRows = function() { return  this.$body.children().length; };
...
{	
	var i=0, rowsCnt = this.getRowCount(); //현재 rows
...
{	
	var rows = this.getRowCount(), colsCnt = this.getColumnCount();
	var r=0, i=0;
...
AGridLayout.prototype.setRowsDivPercent = function()
{
	...
	var i=0, rowsCnt = this.getRowCount(),
...
AGridLayout.prototype.setColsDivPercent = function()
{
	...
	var i=0, colsCnt = this.getColumnCount(),
