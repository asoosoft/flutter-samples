...
class AWebView extends AComponent
{
	constructor()
	{
		super()
...
window.AWebView = AWebView

AWebView.CONTEXT = 
{
    tag: '<div data-base="AWebView" data-class="AWebView" class="AWebView-Style"><iframe frameborder="0" scrolling="auto"></iframe></div>',
...
AWebView.prototype.scrollImplement = function()
{
	...
	this.touchStart = AEvent.bindEvent(cntDoc, AEvent.ACTION_DOWN, function(e)
	{
	...
	this.touchMove = AEvent.bindEvent(cntDoc, AEvent.ACTION_MOVE, function(e)
	{
		var touch1 = e.targetTouches[0];
        var touch2 = e.targetTouches[1];
	...
	this.touchEnd = AEvent.bindEvent(cntDoc, AEvent.ACTION_UP, function(e)
	{
