...
class ATextBox extends AComponent
{
	constructor()
	{
		super()
...
ATextBox.CONTEXT = 
{
    ...
    defStyle: { width:'320px', height:'80px' },
...
ATextBox.prototype.setData = function(data)
{
	this.setText(data);
};

ATextBox.prototype.getData = function()
{
	return this.getText();
};
...
ATextBox.prototype.setMaskValue = ATextBox.prototype.setText;
